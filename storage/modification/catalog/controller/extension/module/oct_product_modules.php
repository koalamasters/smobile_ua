...
class ControllerExtensionModuleOctProductModules extends Controller {
    public function index($setting) {
        ...
        $data['quantity_show'] = (isset($setting['quantity_show']) && !empty($setting['quantity_show'])) ? true : false;
            ...
            foreach ($products as $product_id) {
                ...
                if ($product_info) {
                    ...
                    if ($product_info['image'] && file_exists(DIR_IMAGE.$product_info['image'])) {
                        ...
                        if( $use_avif){
                            $image = $this->model_tool_image->getAvif($product_info['image']);
                        }else{
                    ...
                    $data['products'][] = [
                        ...
                        'product_id2'      => $product_info['product_id'],
                        'thumb'           => $image,
                        'width'           => $width,
                        'height'          => $height,
