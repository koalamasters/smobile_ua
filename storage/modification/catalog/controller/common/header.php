...
class ControllerCommonHeader extends Controller
{
	public function index() {
            ...
            // Flowy Tracking - Get codes to header
                $file = 'library/flowytracking/includes/header.php';
            ...
            // END Flowy Tracking - Get codes to header
		...
		$data['title'] = $this->document->getTitle();
			...
			$this->document->addScript('catalog/view/javascript/salesdrive.js');
        ...
        $this->document->addScript('catalog/view/javascript/jquery/salesagent.js');
