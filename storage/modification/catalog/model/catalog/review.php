...
class ModelCatalogReview extends Model {
	public function addReview($product_id, $data) {
		...
		if ($this->config->get('remarketing_status') && !$this->model_tool_remarketing->isBot() && $this->config->get('remarketing_telegram_status') && $this->config->get('remarketing_telegram_contact_form')) {
			$this->model_tool_remarketing->sendTelegramMsg($message);
		}
    ...
    public function getReviewById($review_id){
        $query = $this->db->query("
SELECT r.review_id, r.author, r.rating, r.text, r.reply, p.product_id, pd.name, p.price, p.image, r.date_added 
