...
$_['text_home_b'] = 'Домашня сторінка';
$_['text_yes'] = 'Так';
$_['text_no'] = 'Ні';
...
$_['button_submit_new'] = 'Відправити';
...
$_['quickviewText_main'] = 'Швидкий перегляд';
...
$_['mail_special'] = 'Акції';
$_['mail_special_link'] = 'https://smobile.ua/index.php?route=product/special';

$_['mail_contacts'] = 'Контакти';
$_['mail_contacts_link'] = 'https://smobile.ua/index.php?route=information/contact';
			if (file_exists(DIR_MODIFICATION . "catalog/language/uk-ua/octemplates/oct_showcase.php")) {
				include(DIR_MODIFICATION . "catalog/language/uk-ua/octemplates/oct_showcase.php");
			} else {
				include(DIR_LANGUAGE."uk-ua/octemplates/oct_showcase.php");
			}
