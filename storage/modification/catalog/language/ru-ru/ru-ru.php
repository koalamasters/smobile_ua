...
// Text
$_['text_home']             = 'Домашняя страница';
$_['text_home_b']             = 'Домашняя страница';
$_['text_yes']              = 'Да';
$_['text_no']               = 'Нет';
...
$_['quickviewText_main'] = 'Быстрый просмотр';
...
$_['mail_cat'] = 'Каталог';
$_['mail_cat_link'] = 'https://smobile.ua/index.php?route=product/catalog';

$_['mail_special'] = 'Акции';
$_['mail_special_link'] = 'https://smobile.ua/index.php?route=product/special';

$_['mail_contacts'] = 'Контакты';
$_['mail_contacts_link'] = 'https://smobile.ua/index.php?route=information/contact';
			if (file_exists(DIR_MODIFICATION . "catalog/language/ru-ru/octemplates/oct_showcase.php")) {
				include(DIR_MODIFICATION . "catalog/language/ru-ru/octemplates/oct_showcase.php");
			} else {
				include(DIR_LANGUAGE."ru-ru/octemplates/oct_showcase.php");
			}
