...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
      ...
      if (!in_array('universal_import', $this->model_setting_extension->getInstalled('module'))) {
        ...
        $this->load->language("extension/module/salesagent_links");
        $salesagent = array();

        if ($this->user->hasPermission('access', 'extension/module/salesagent')) {
          $salesagent[] = array(
            'name'     => $this->language->get('menu_salesagentlist'),
        ...
        if ($this->user->hasPermission('access', 'extension/module/salesagent')) {
          $salesagent[] = array(
            'name'     => $this->language->get('menu_catalogs'),
            'href'     => $this->url->link('extension/module/salesagent/salesagentclist', 'user_token=' . $this->session->data['user_token'], true),
            'children' => array()   
          );
        }
        if ($this->user->hasPermission('access', 'extension/report/salesagent')) {
          $salesagent[] = array(
            'name'     => $this->language->get('menu_salesagentreport'),
            'href'     => $this->url->link('extension/report/salesagent/orderreport', 'user_token=' . $this->session->data['user_token'], true),
            'children' => array()   
          );
        }
        if ($this->user->hasPermission('access', 'extension/report/salesagent')) {
          $salesagent[] = array(
            'name'     => $this->language->get('menu_salesagent_payout'),
            'href'     => $this->url->link('extension/report/salesagent/payouts', 'user_token=' . $this->session->data['user_token'], true),
            'children' => array()   
          );
        }
        if ($this->user->hasPermission('access', 'extension/report/salesagent')) {
          $salesagent[] = array(
            'name'     => $this->language->get('menu_salesagentreportct'),
            'href'     => $this->url->link('extension/report/salesagent/customerreport', 'user_token=' . $this->session->data['user_token'], true),
            'children' => array()   
          );
        }
        if ($salesagent) {
          $data['menus'][] = array(
            'id'       => 'menu-salesagent',
            'name'     => $this->language->get('menu_salesagent'),
            'icon'     => 'fa-user-secret', 
            'href'     => '',
            'children' => $salesagent 
          );
		...
		if ($this->config->get('remarketing_status') && $this->user->hasPermission('access', 'report/remarketing_report')) {
			...
			$data['menus'][] = array(
				...
				// Preorder
				if ($this->config->get('module_preorder_menu')) {
					$this->load->language('common/preorder');
					
					$data['menus'][] = array(
						'id'       => 'menu-preorder',
						'icon'	   => 'fa-bell',
						'name'	   => $this->language->get('text_menu_preorder'),
