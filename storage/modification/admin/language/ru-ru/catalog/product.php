...
$_['ex_pak_tab_title']       = 'Аксессуары/Комплекты';
...
$_['help_special']				= 'При включении данной опции, цена товара при оформлении кредита будет без учета акций';
...
$_['credit_type_ab']			= 'Легкая рассрочка (Sense bank)';
$_['credit_type_sb']			= 'Кредит (Sense bank)';
$_['credit_type_aa']			= 'Плати частями (А-Банк)';
$_['credit_type_pl']			= 'Плати позже';
$_['credit_type_pu']			= 'Оплата частями (ПУМБ)';
