<?php
$_['tab_hpm']        = '<b style="color:green;">HPMrr</b>';
// Heading

$_['ex_pak_tab_title']       = 'Аксесуари/Комплекти';
...
$_['tab_ukrcredits'] 			= 'Кредити';
$_['credit_type'] 				= 'Тип кредитування:';
$_['partsCount'] 				= 'Максимум місяців:';
$_['markup'] 					= 'Коефіцієнт націнки:';
$_['special'] 					= 'Заборонити акції:';
$_['help_partsCount'] 			= 'Введіть максимальну кількість місяців кредитування';
$_['help_markup'] 				= 'Якщо необхідно, встановіть націнку на вартість товару, наприклад, 1.027, що становить 2.7%';
$_['help_special'] 				= 'При включенні даної опції ціна товару при оформленні кредиту буде без урахування акцій';
$_['credit_type_ii'] 			= 'Миттєва розстрочка (Приватбанк)';
$_['credit_type_pp'] 			= 'Оплата частинами (Приватбанк)';
$_['credit_type_mb'] 			= 'Покупка частинами (Монобанк)';
$_['credit_type_ab'] 			= 'Легка розстрочка (Sense bank)';
$_['credit_type_sb']			= 'Кредит (Sense bank)';
$_['credit_type_aa'] 			= 'Платі частинами (А-Банк)';
$_['credit_type_pl'] 			= 'Плати пізніше';
$_['credit_type_pu'] 			= 'Оплата частинами (ПУМБ)';
