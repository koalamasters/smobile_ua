...
final class Loader {
	...
	public function __construct($registry) {
		$this->registry = $registry;
              ...
              $registry->set("kjhelper", new \kjhelper($registry));
	...
	public function model($route) {
		...
		if ($route == 'extension/payment/ukrcredits_pp' || $route == 'extension/payment/ukrcredits_ii' || $route == 'extension/payment/ukrcredits_mb' || $route == 'extension/payment/ukrcredits_ab' || $route == 'extension/payment/ukrcredits_sb' || $route == 'extension/payment/ukrcredits_aa' || $route == 'extension/payment/ukrcredits_pl' || $route == 'extension/payment/ukrcredits_pu' || $route == 'extension/payment/ukrcredits' || $route == 'extension/total/totalukrcredits') {
