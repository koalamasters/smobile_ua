...
$_['text_login'] = 'Ви повинні <a href="javascript:open_login_popup()">увійти</a> або <a href="javascript:open_register_popup()">створити обліковий запис</a>, щоб зберегти <a href="%s">%s</a> ваш <a href="%s">список закладок</a>!';
