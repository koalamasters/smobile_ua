...
$_['text_payment_on_delivery']       = 'Комиссия за денежный перевод при оплате при получении товара (2% от суммы + 20 грн)';
$_['text_i_am_returning_customer']   = 'Я совершал здесь покупки ранее и регистрировался';
$_['text_forgotten']                 = 'Забыли пароль?';
$_['text_address_new']               = 'Добавить и использовать новый адрес';
...
$_['text_agree']                     = 'Подтверждая заказ, я принимаю условия <a href="%s" class="agree">%s</a>';
...
$_['entry_address_1']                = 'Укажите адрес';
...
$_['additinal_wait']                 = 'Ожидается подтверждение...';

$_['text_or']                       = 'Или';
$_['text_auth_with_goole']          = 'Войти через Google';

$_['placeholder_firstname']         = 'Введите ваше Имя';
$_['placeholder_lastname']          = 'Введите вашу Фамилию';
$_['placeholder_email']          = 'Введите ваш Email';
$_['placeholder_phone']          = '+38 (___) ___-__-__';
$_['no_call_notice']          = 'Оформление заявки без звонка менеджера. Информацию о статусе заказа вы получите на вашу электронную почту.';

$_['cart'] = 'Корзина';
$_['edit_cart'] = 'Редактировать';
$_['cart_notice'] = 'Товары в корзине не бронируются и могут быть распроданы';

$_['products_total']          = 'Сума товаров';
$_['sale_price']          = 'Скидка';
$_['delivery_carrier_tariffs'] = 'По тарифам перевозчика';
$_['delivery_free'] = 'Бесплатно';
$_['full_total']          = 'Всего';