...
$_['text_items']               = 'В корзине <span>%s товаров</span><br />на сумму <span>%s</span>';
...
$_['delete'] = 'Удалить';
$_['clear_cart'] = 'Очистить корзину';
$_['clear_cart_success'] = '<span class="fsz-16 d-flex" style="height: 100%; align-items: center;">Корзина очищена</span>';
$_['checked'] = 'Выбрано';
