...
// Text
$_['text_success'] = '<span class="fsz-16"><a href="%s" class="fsz-16">%s</a> добавлен <a class="fsz-16" href="%s">в корзину</a>!<span>';
...
$_['total_title'] = 'Итог заказа';
$_['delete'] = 'Удалить';
$_['checked'] = 'Выбрано';

$_['off_dist'] = 'Официальный<br>Дистрибьютор';
$_['free_delivery'] = 'Бесплатная<br>Доставка';
$_['crypto_pay'] = 'Оплата<br>Криптовалютой';
$_['part_pay'] = 'Оплата<br>частями';
