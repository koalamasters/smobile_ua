...
$_['text_login']    = 'Вы должны <a href="javascript:open_login_popup()">выполнить вход</a> или <a href="javascript:open_register_popup()">создать аккаунт</a> чтобы сохранить <a href="%s">%s</a> в свой <a href="%s">список закладок</a>!';
