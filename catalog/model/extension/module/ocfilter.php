...
class ModelExtensionModuleOCFilter extends Model {
  ...
  public function getFilters($data = []) {
    ...
    if (isset($data['filter_key'])) {
      ...
      array_unshift($results, $this->ocfilter->params->special('stock')->key());
      array_unshift($results, $this->ocfilter->params->special('newest')->key());
      array_unshift($results, $this->ocfilter->params->special('discount')->key());
      array_unshift($results, $this->ocfilter->params->special('manufacturer')->key());
      array_unshift($results, $this->ocfilter->params->special('price')->key());
    }
