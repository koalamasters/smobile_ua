...
class ControllerToolGooglemerchantRu extends Controller {
    public function index(){
        ...
        $output .= '<link rel="self" href="https://smobile.ua/ru"/> '."\n";
        $output .= '<description>SMobile - торговые объявления интернет магазина</description>'."\n";
        ...
        foreach ($products as $key => $product) {
            ...
            $description = "Заказывайте онлайн ".$product['name']." от компании ".$product['manufacturer']." с возможностью возврата и обмена и доставкой по всей Украине. Модель - ".$product['sku'].".";
