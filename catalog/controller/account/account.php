...
class ControllerAccountAccount extends Controller {
	public function index() {
        ...
        $data['text_lastname'] = $this->language->get('lastname');
        $data['text_telephone'] = $this->language->get('telephone');
        $data['text_email'] = $this->language->get('email');
        $data['text_edit'] = $this->language->get('edit');
