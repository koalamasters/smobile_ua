...
$_['text_ecommerce']        = 'Электронная торговля Google';
$_['text_ecommerce_gtag']        = 'Электронная торговля Google';
$_['text_ecommerce_ga4']        = 'Электронная торговля Google GA4';
$_['text_ecommerce_ga4_send_way']        = 'Отправка данных через';
$_['text_ecommerce_ga4_measurement']        = 'Электронная торговля Google GA4 - Measurement Protocol ';
$_['text_ecommerce_measurement']        = 'Электронная торговля Google - Measurement Protocol (без gtag.js и dataLayer)';
...
$_['text_feed']        = 'Фид для Google Merchant и Facebook (+Tiktok)'; 
...
$_['text_feed_help']    = 'К ссылкам можно добавлять GET-параметры языка, валюты и ID магазина (для мультимагазинов)<br><br>Как пример - store_id=1 - будут выгружены товары из магазина с ID 1<br>language=ru-ru - фид принудительно будет на русском языке<br>currency=USD - фид будет в USD<br>Язык и валюта должны существовать в магазине и быть включенными.<br><br>Если вы используете языковые префиксы типа ru, ua, uk для переключения языков - можно их подставлять в ссылку.<br> Например, https://вашсайт/ua/ссылка_из_модуля или https://вашсайт/ссылка_из_модуля&language=uk-ua<br>
<br>Поддерживаются параметры - categories,not_categories,manufacturers - через зпт можно указать только из каких категорий, категории из которых не выгружать, производители которых выгружать'; 
...
$_['text_reviews_warning']        = '<b>Отзывы Google Merchant</b> - не заполнены обязательные поля (Идентификатор, страна доставки, прибавить дней к текущей дате)'; 
...
$_['entry_debug_mode']     = 'Режим отладки (логирование серверных событий)';
$_['entry_autoclear_mode']     = 'Автоочистка базы данных (удаляются записи старше 6 мес)';
$_['entry_show_in_order']     = 'Показывать кнопки модуля в просмотре заказа';
...
$_['entry_google_ads_quick_order_identifier']     = 'Идентификатор конверсии Google Adwords для оформления быстрого заказа<br>
(AW-CONVERSION_ID/AW-CONVERSION_LABEL)'; 
...
$_['entry_ecommerce_quick_order_event_name']   = 'Название события быстрого заказа (например, quick_order)';
...
$_['entry_remarketing_feed_utm_tiktok']   = 'UTM-метки для Tiktok. Переменные: {product_id}, {product_model}';
$_['entry_remarketing_feed_empty_brand']   = 'Производитель, если не заполнено';
$_['entry_remarketing_feed_original_description']   = 'HTML-описание'; 
$_['entry_remarketing_feed_rich_text']   = 'Выгрузить rich_text_description для Facebook';   
...
$_['entry_remarketing_feed_highlight']   = 'Откуда брать product_highlight (Отличительные черты товара). Пример: meta_keyword, meta_h1 и тп.';
$_['entry_remarketing_feed_replace_description']   = 'Откуда брать описание, если не из description. Пример: meta_keyword, meta_h1 и тп.';
$_['entry_remarketing_feed_color']   = 'color - ID (!) атрибута (или несколько через зпт) из которого брать параметр';
$_['entry_remarketing_feed_size']   = 'size - ID (!) атрибута (или несколько через зпт) из которого брать параметр';
$_['entry_remarketing_feed_material']   = 'material - ID (!) атрибута (или несколько через зпт) из которого брать параметр';
$_['entry_remarketing_feed_gender']   = 'gender - ID (!) атрибута (или несколько через зпт) из которого брать параметр';
$_['entry_remarketing_feed_age_group']   = 'age_group - ID (!) атрибута (или несколько через зпт) из которого брать параметр';
...
$_['entry_remarketing_feed_always_avail']   = 'Все товары в наличии';
$_['entry_remarketing_feed_in_stock']   = 'Статус "Есть в наличии" (принудительно)';
$_['entry_remarketing_feed_out_of_stock']   = 'Статус "Нет в наличии" (принудительно)';
...
$_['entry_remarketing_feed_all_attributes']   = 'Выгружать все атрибуты в product_detail (намного медленнее)';
$_['entry_remarketing_feed_adult']   = 'Все товары для взрослых';
$_['entry_remarketing_feed_description']   = 'Если описание пустое - использовать этот текст. Можно {product_name}, {product_model}';
$_['entry_remarketing_feed_short_desc']    = 'Обрезать описание (кол-во символов)'; 
$_['entry_remarketing_feed_replace_from']   = 'Заменить с (во всем фиде), каждое значение с новой строки';
$_['entry_remarketing_feed_replace_to']   = 'Заменить на (во всем фиде), каждое значение с новой строки';
...
$_['entry_tiktok_ratio']   = 'Коэффициент суммы транзакции (0.7 - 70%, 1 - 100% от суммы и тп)';
...
$_['entry_snapchat_ratio']   = 'Коэффициент суммы транзакции (0.7 - 70%, 1 - 100% от суммы и тп)';
