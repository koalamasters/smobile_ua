...
$_['text_ecommerce_ga4_send_way']        = 'Send data via';
...
$_['text_feed']        = 'Feed For Google Merchant & Facebook (+Tiktok)'; 
...
$_['text_feed_help']    = 'GET parameters allowed<br><br>For example - store_id=1 - export products from store with ID 1 (for multistores)<br>language=ru-ru - russian feed<br>currency=USD - USD in feed<br>
<br>For example, https://yoursite/ua/link_from_module or https://yoursite/link_from_module&language=uk-ua<br>
Parameters supported - categories, not_categories, manufacturers - you can specify only from which categories, categories from which not to unload, manufacturers of which to unload'; 
...
$_['text_reviews_warning']        = 'b>Google Merchant Reviews</b> - mandatory fields not filled in (ID, shipping country, add days to current date)'; 
...
$_['text_mp_id_warning']        = '<b>Google Analytics 4 (MP)</b> - no tracking ID entered (G-XXXXXXXXX) or API key'; 
...
$_['entry_debug_mode']     = 'Debug mode (log server events)';
$_['entry_autoclear_mode']     = 'Database auto-cleanup (records older than 6 months are deleted)';
$_['entry_show_in_order']     = 'Show module buttons in order view';
...
$_['entry_google_ads_quick_order_identifier']     = 'Quick Order Conversion Identifier Google Adwords<br>
(AW-CONVERSION_ID/AW-CONVERSION_LABEL)';
...
$_['entry_ecommerce_ratio'] = 'Ecommerce Ratio (0.7 - 70%, 1 - 100% etc)';
$_['entry_facebook_ratio']     = 'Facebook Ratio (0.7 - 70%, 1 - 100% etc)';
...
$_['entry_server_side']   = 'Enable Marketing API';
...
$_['entry_ecommerce_quick_order_event_name']   = 'Event name for quick order (for example quick_order)';
...
$_['entry_remarketing_feed_utm_tiktok']   = 'UTM for Tiktok. Variables: {product_id}, {product_model}';
$_['entry_remarketing_feed_empty_brand']   = 'Brand name if product brand is empty'; 
$_['entry_remarketing_feed_original_description']   = 'HTML-description';
$_['entry_remarketing_feed_rich_text']   = 'Export rich_text_description for Facebook';   
...
$_['entry_remarketing_feed_mpn']   = 'MPN field if needed. For example: sku, upc, mpn etc.';
$_['entry_remarketing_feed_highlight']   = 'product_highlight field if needed. For example: meta_keyword, meta_h1 etc.';
$_['entry_remarketing_feed_replace_description']   = 'Replace description field if needed. For example: meta_keyword, meta_h1 etc.';
$_['entry_remarketing_feed_color']   = 'color - product attribute ID (!), multiple - separated by comma';
$_['entry_remarketing_feed_size']   = 'size - product attribute ID (!), multiple - separated by comma';
$_['entry_remarketing_feed_material']   = 'material - product attribute ID (!), multiple - separated by comma';
$_['entry_remarketing_feed_gender']   = 'gender - product attribute ID (!), multiple - separated by comma';
$_['entry_remarketing_feed_age_group']   = 'age_group - product attribute ID (!), multiple - separated by comma';
$_['entry_remarketing_feed_store_code']   = 'store_code';
$_['entry_remarketing_feed_zero_quantity']   = 'Quantity greater than 0'; 
$_['entry_remarketing_feed_always_avail']   = 'All products always available';
$_['entry_remarketing_feed_in_stock']   = 'Status "In Stock" (force)';
$_['entry_remarketing_feed_out_of_stock']   = 'Status "Out Of Stock" (force)';
...
$_['entry_remarketing_feed_all_attributes']   = 'Export all attributes to product_detail (very slower)';
$_['entry_remarketing_feed_adult']   = 'Adult products';
$_['entry_remarketing_feed_description']   = 'Empty description text. {product_name}, {product_model}';
$_['entry_remarketing_feed_short_desc']    = 'Truncate description (number of characters)';
$_['entry_remarketing_feed_replace_from']   = 'Replace from, each on a new line';
$_['entry_remarketing_feed_replace_to']   = 'Replace to, each on a new line';
...
$_['entry_tiktok_ratio']   = 'Transaction Ratio (0.7 - 70%, 1 - 100%)';
