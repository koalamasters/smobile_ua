...
$_['error_meta_keyword']     = 'Мета тег keyword должен быть до %s символов!';
$_['error_meta_description'] = 'Мета тег description должен быть до %s символов!';
...
$_['error_batch_edit_something'] = 'Что-то пошло не так';