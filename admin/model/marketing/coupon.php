...
class ModelMarketingCoupon extends Model {
	public function addCoupon($data) {
		...
		discount = '" . (float)$data['discount'] . "', type = '" . $this->db->escape($data['type']) . "', 
		...
		ignore_special = '" . (int)(isset($data['ignore_special']) ? $data['ignore_special'] : 0) . "',
		admitad = '" . (int)(isset($data['admitad']) ? $data['admitad'] : 0) . "',
		purpose = '" . $this->db->escape($data['purpose']) . "',
		date_added = NOW()");
