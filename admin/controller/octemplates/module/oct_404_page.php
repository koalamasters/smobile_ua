...
class ControllerOCTemplatesModuleOct404Page extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            if (isset($this->request->post['oct_404_page_status']) && $this->request->post['oct_404_page_status'] == 'on') {
				$this->addEvent();
			} else {
				$this->deleteEvent();
			}
    ...
    public function addEvent() {
		...
		if ($this->model_setting_event->getEventByCode('octemplates-showcase-404-not-found')) {
			return;
		}
		...
		$events = [
			[
				'code' => 'octemplates-showcase-404-not-found',
				'trigger' => 'catalog/view/error/not_found/before',
				'action' => 'octemplates/events/not_found'
			]
		];
	...
	public function deleteEvent() {
		...
		$eventCodes = [
			'octemplates-showcase-404-not-found'
		];
    ...
    public function install() {
        ...
        $this->model_setting_setting->editSetting('oct_404_page', [
            ...
            'oct_404_page_data' => [
                'image' => 'catalog/showcase/404.svg',
