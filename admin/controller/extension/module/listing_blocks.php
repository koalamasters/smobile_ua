<?php
class ControllerExtensionModuleListingBlocks extends Controller {
    private $error = [];

    public function index() {
        $this->load->language('extension/module/listing_blocks');
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            if (!isset($this->request->get['module_id'])) {
                $this->model_setting_module->addModule('listing_blocks', $this->request->post);
            } else {
            ...
            if (isset($this->request->post['apply'])) {
                ...
                $this->response->redirect($this->url->link('extension/module/listing_blocks',
        ...
        $data['breadcrumbs'] = [
            ...
            [
                ...
                'href' => $this->url->link('extension/module/listing_blocks', 'user_token=' . $this->session->data['user_token'], true)
            ]
        ];

        $data['action'] = isset($this->request->get['module_id']) ?
            $this->url->link('extension/module/listing_blocks',
        ...
        $this->response->setOutput($this->load->view('extension/module/listing_blocks', $data));
    }
    ...
    public function blockForm() {
        ...
        $data['languages'] = $this->model_localisation_language->getLanguages();
        $this->response->setOutput($this->load->view('extension/module/listing_blocks_block', $data));
    }
    ...
    protected function renderBlock($index, $block = []) {
        ...
        return $this->load->view('extension/module/listing_blocks_block', $data);
    }
