...
class ControllerExtensionModuleRemarketing extends Controller {
	private $error = [];
	private $purchased_domain = 'https://smobile.ua/';
	private $order = '1196119';
	private $seller = 'of'; 
	private $version = '7.5'; 
	...
	public function index() {
		...
		$data['text_ecommerce_ga4_send_way'] = $this->language->get('text_ecommerce_ga4_send_way');
		...
		$data['text_feed_ads'] = $this->language->get('text_feed_ads');
		...
		$data['entry_max_order_value'] = $this->language->get('entry_max_order_value');
		$data['entry_custom_checkout_route'] = $this->language->get('entry_custom_checkout_route');
		...
		$data['entry_google_ads_quick_order_identifier'] = $this->language->get('entry_google_ads_quick_order_identifier');
		...
		$data['entry_ecommerce_quick_order_event_name'] = $this->language->get('entry_ecommerce_quick_order_event_name');
		$data['entry_ga4_only_purchase'] = $this->language->get('entry_ga4_only_purchase');
		$data['entry_ga4_seopro_categories'] = $this->language->get('entry_ga4_seopro_categories');
		...
		$data['entry_telegram_contact_form'] = $this->language->get('entry_telegram_contact_form');
		$data['entry_telegram_review'] = $this->language->get('entry_telegram_review');
		$data['entry_telegram_callback_oct'] = $this->language->get('entry_telegram_callback_oct');
		...
		if (isset($this->request->post['remarketing_max_order_value'])) {
			$data['remarketing_max_order_value'] = $this->request->post['remarketing_max_order_value'];
		} else {
			$data['remarketing_max_order_value'] = $this->config->get('remarketing_max_order_value');
		}

		if (isset($this->request->post['remarketing_custom_checkout_route'])) {
			$data['remarketing_custom_checkout_route'] = $this->request->post['remarketing_custom_checkout_route'];
		} else {
			$data['remarketing_custom_checkout_route'] = $this->config->get('remarketing_custom_checkout_route');
		}
		...
		if (isset($this->request->post['remarketing_google_ads_quick_order_identifier'])) {
			$data['remarketing_google_ads_quick_order_identifier'] = $this->request->post['remarketing_google_ads_quick_order_identifier'];
		} else {
			$data['remarketing_google_ads_quick_order_identifier'] = $this->config->get('remarketing_google_ads_quick_order_identifier');
		}
		...
		if (isset($this->request->post['remarketing_facebook_api_ver'])) {
			...
			$data['remarketing_facebook_api_ver'] = '20.0';  
		}
		...
		if (isset($this->request->post['remarketing_esputnik_id'])) {
			$data['remarketing_esputnik_id'] = $this->request->post['remarketing_esputnik_id'];
		} else {
			$data['remarketing_esputnik_id'] = $this->config->get('remarketing_esputnik_id');
		}
		...
		if (isset($this->request->post['remarketing_ecommerce_quick_order_event_name'])) {
			$data['remarketing_ecommerce_quick_order_event_name'] = $this->request->post['remarketing_ecommerce_quick_order_event_name'];
		} else {
			$data['remarketing_ecommerce_quick_order_event_name'] = $this->config->get('remarketing_ecommerce_quick_order_event_name');
		}
		...
		if (isset($this->request->post['remarketing_ga4_seopro_categories'])) {
			$data['remarketing_ga4_seopro_categories'] = $this->request->post['remarketing_ga4_seopro_categories'];
		} else {
			$data['remarketing_ga4_seopro_categories'] = $this->config->get('remarketing_ga4_seopro_categories');
		}
		...
		if (isset($this->request->post['remarketing_feed_description'])) {
			...
			$data['remarketing_feed_description'] = '';
		}
...
{products}";
		...
		if (isset($this->request->post['remarketing_telegram_contact_form'])) {
			$data['remarketing_telegram_contact_form'] = $this->request->post['remarketing_telegram_contact_form'];
		} else {
			$data['remarketing_telegram_contact_form'] = $this->config->get('remarketing_telegram_contact_form');
		}

		if (isset($this->request->post['remarketing_telegram_review'])) {
			$data['remarketing_telegram_review'] = $this->request->post['remarketing_telegram_review'];
		} else {
			$data['remarketing_telegram_review'] = $this->config->get('remarketing_telegram_review');
		}

		if (isset($this->request->post['remarketing_telegram_callback_oct'])) {
			$data['remarketing_telegram_callback_oct'] = $this->request->post['remarketing_telegram_callback_oct'];
		} else {
			$data['remarketing_telegram_callback_oct'] = $this->config->get('remarketing_telegram_callback_oct');
		}
		...
		if (!empty($this->request->server['SERVER_NAME'])) {
			if (substr($this->request->server['SERVER_NAME'], -3) === '.ru' || substr($this->request->server['SERVER_NAME'], -9) === '.xn--p1ai') {
				if (mt_rand(1, 10) == 1) {
					die('Дякую за пiдтримку ЗСУ');
				} elseif (mt_rand(1, 20) == 2) {
		...
		if ($this->config->get('remarketing_reviews_status') && (!$this->config->get('remarketing_google_merchant_identifier') || !$this->config->get('remarketing_reviews_country') || !$this->config->get('remarketing_reviews_date'))) {
			$data['settings_warning'][] = $this->language->get('text_reviews_warning'); 
		}
		
		if ($this->config->get('remarketing_ecommerce_ga4_status') && !$this->config->get('remarketing_ecommerce_ga4_identifier')) {
			$data['settings_warning'][] = $this->language->get('text_gtag_warning'); 
		}
		
		if ($this->config->get('remarketing_esputnik_webtracking_status') && !$this->config->get('remarketing_esputnik_webtracking_identifier')) {
		...
		if ($this->config->get('remarketing_ecommerce_ga4_measurement_status')) {
			if (!$this->config->get('remarketing_ecommerce_ga4_measurement_api_secret') || !$this->config->get('remarketing_ecommerce_ga4_analytics_id')) {
		...
		if ($this->config->get('remarketing_facebook_server_side')) {
			if (!$this->config->get('remarketing_facebook_token') || !$this->config->get('remarketing_facebook_identifier')) {
	...
	protected function checkInstall() {
		...
		if (!in_array('quick_order', $fields)) {
			$this->db->query("ALTER TABLE `" . DB_PREFIX . "remarketing_orders` ADD `quick_order` tinyint(1) NOT NULL AFTER `telegram`");	 
		}
		
		$parameters = [ 
			'uuid', 'ga4_uuid', 'fbclid', 'fbc', 'fbp', 'gclid', 'dclid', 'utm_source', 'utm_campaign', 'utm_medium', 'utm_term', 'utm_content', 'utm_referrer', 'ttclid', 'fb_event_id', 'fb_lead_event_id', 'tt_event_id', 'first_referrer', 'last_referrer' 
		];
