...
class ControllerExtensionModuleOctSlideshowPlus extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['slider_with_megamenu'])) {
			$data['slider_with_megamenu'] = $this->request->post['slider_with_megamenu'];
		} elseif (!empty($module_info)) {
			$data['slider_with_megamenu'] = isset($module_info['slider_with_megamenu']) ? $module_info['slider_with_megamenu'] : '';
		} else {
			$data['slider_with_megamenu'] = '';
		}
