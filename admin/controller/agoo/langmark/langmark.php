...
$('".$this->language->get('text_anchor_templates_selector')."').html(data);",
		...
		if (isset($this->data['ascp_widgets'][$this->data['id']]['bots']) && (stripos($this->data['ascp_widgets'][$this->data['id']]['bots'], 'Inspection') === false)) {
			$this->data['ascp_widgets'][$this->data['id']]['bots'] =					
			'Inspection' . PHP_EOL .
			'Google-InspectionTool' . PHP_EOL . $this->data['ascp_widgets'][$this->data['id']]['bots'];		
		}
